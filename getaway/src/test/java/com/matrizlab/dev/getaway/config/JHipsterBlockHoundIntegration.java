...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.matrizlab.dev.getaway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.matrizlab.dev.getaway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
